  ...
  return (
    <section className="flex flex-col justify-between items-center gap-9 sm:max-2l:gap-12 my-20">
      <div className="text-[1.6rem] sm:max-2xl:text-[2.3rem] font-main text-display-text text-center">
        Interior Design Solutions That Fit Your Life
      </div>
      ...
      <div className="py-2 px-5 w-full sm:max-2xl:w-[90%] md:max-lg:w-[97%] mx-auto grid grid-cols-2 sm:max-2xl:grid-cols-3 sm:max-2xl:grid-rows-2 place-items-center gap-6 sm:max-2xl:gap-8">
        {frameValues.map((item, index) => (
          <div
            key={index}
            className="border-2 border-gold-section-color rounded-md w-[45vw] h-[75vh] max-[235px]:h-[85vh] sm:w-48 sm:h-88 md:max-2xl:w-60 md:max-2xl:h-88 lg:max-2xl:w-[18rem] lg:max-2xl:h-92 flex flex-col justify-center items-center py-3 md:max-2xl:py-5"
          >
            <div className="w-[85%] mx-auto">
              ...
              ></div>
              <p className="font-hanken text-display-text text-[1rem] sm:max-lg:text-[1.2rem] lg:text-[1.36rem] w-[80%] md:w-full max-[380px]:w-full max-[295px]:break-all">
                {item.frameTxt}
              </p>
              ...
              <div className="flex justify-between items-center">
                ...
                >
                  <p className="font-hanken">Learn More</p>
                  <Image
